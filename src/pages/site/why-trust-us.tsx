  ...
  const trustFactors = [
    {
      ...
      description:
        "Bank-level encryption and security protocols protect your data and searches.",
      color: "blue",
    },
    {
      icon: Database,
      ...
      description:
        "Access to the world's largest IMEI database with real-time updates from multiple sources.",
      color: "green",
    },
    {
      icon: Zap,
      ...
      description:
        "Get instant verification results in under 3 seconds with our optimized infrastructure.",
      color: "yellow",
    },
    {
      icon: Lock,
      ...
      description:
        "Your searches are private and never stored. We prioritize user privacy above all.",
      color: "purple",
    },
    {
      icon: Award,
      ...
      description:
        "Trusted by law enforcement, insurance companies, and mobile retailers worldwide.",
      color: "orange",
    },
    {
      icon: Users,
      ...
      description:
        "Crowdsourced data from verified users ensures the most up-to-date information.",
      color: "teal",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="-mt-24 bg-zinc-100 dark:bg-zinc-950">
        <div className="container py-32 lg:py-40">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <Badge className="section-badge">Why Trust FoneOwner</Badge>
            <h1 className="page-title">
              The most trusted IMEI verification platform worldwide
            </h1>
            <p className="section-subtitle max-w-3xl mx-auto">
              Join millions who trust FoneOwner for secure, accurate, and
              instant device verification. Here's why we're the industry leader
      ...
      <section className="section-space">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <div className="section-badge">Trust & Security</div>
        ...
        <div className="container">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, white 0%, white 50%, rgba(255,255,255,0.5) 70%, transparent 100%)",
              }}
            ></div>
              ...
              <div className="max-w-2xl">
                <div>
                  ...
                  <p className="section-subtitle text-balance">
                    From small retailers to Fortune 500 companies, FoneOwner is
                    the preferred choice for device verification and fraud
                    prevention.
                  </p>
      ...
      <section className="section-space">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <div className="section-badge">Certifications & Compliance</div>
            <h2 className="section-title">
              Meeting the highest industry standards
            </h2>
            <p className="section-subtitle">
              We maintain rigorous certifications and compliance standards to
