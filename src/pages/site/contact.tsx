        ...
        <div className="container py-t lg:pt-40 pb-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="section-subtitle max-w-2xl mx-auto">
              Have questions about IMEI verification? Need support? We're here to help. 
      ...
      <div className="container">
        ...
        <div className="space-y-8 md:col-span-2">
          <Card>
            ...
            <a href="mailto:fonsaveofficial@gmail.com" className="text-primary hover:underline font-medium">
              fonsaveofficial@gmail.com
            </a>
            </CardContent>
          </Card>
          <Card>
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="inline w-4 h-4" viewBox="0 0 32 32" fill="currentColor">
