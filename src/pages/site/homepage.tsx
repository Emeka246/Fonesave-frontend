          ...
          <div className="grid grid-col-1 md:grid-cols-2 md:gap-12 items-center">
            ...
            <div className="space-y-4 md:space-y-8 md:px-10">
              <div className="hidden md:flex items-center justify-start gap-4 ">
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-bold">Rated 5.0</h3>
              ...
              <div className="">
                ...
                <p className="section-subtitle">
                  Protect your phone, avoid buying stolen phones, earn as a
                  FoneOwner Agent by helping others register their phones.
                </p>
              </div>
            ...
            <div className="col-span-2 md:col-span-1">
              <div className="panel-accent px-10 md:px-20  justify-start h-full md:min-h-[300px]">
                ...
                <p className="text-lg md:text-2xl">
                  Every action (registered, marked stolen, recovered,
                  transferred) is logged with timestamps
                </p>
              </div>
            </div>
            <div className="col-span-2 md:col-span-1">
            ...
            <div className="col-span-2 panel-accent px-10 md:px-20">
              <div className="flex items-end justify-between">
                <div className="max-w-2xl mr-auto">
                  ...
                  <p className="text-lg md:text-2xl">
                    For a annual fee of <strong>₦1,000</strong> (Nigeria) per
                    phone, users can verify their device's status and ownership.
                  </p>
                  <div>
                    <Button
                      onClick={() => navigate(ROUTES.NEW_REGISTRATION)}
      ...
      <div className="py-20 bg-black mt-20">
        <div className="container px-4 sm:px-6 lg:px-8 text-white">
          <div className="mb-10 border-b border-zinc-800 pb-8">
            <div className="section-badge">How to Find Your IMEI</div>
            <div className="grid md:grid-cols-2 gap-4 md:gap-8 items-center">
              ...
              <div className="flex-1 flex items-center justify-end">
                <p className="section-subtitle m-0 max-w-xl ml-auto">
                  ...
                  identifier for your mobile device. It helps in tracking,
                  verifying, and securing your device.
                </p>
              </div>
            </div>
          </div>
