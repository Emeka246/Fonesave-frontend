...
const navigationItems: { title: string; href: string; description: string; }[] = [
  ...
  },
  {
    title: "Why Trust Us",
    href: "/why-trust-us",
    description: "Learn why millions trust FonSave for device verification",
  },
  {
    title: "About",
    href: "/about",
        ...
        <div className="flex w-full items-center justify-between h-16">
          ...
          <div className="lg:hidden flex items-center">
            ...
            <DropdownMenu open={open} onOpenChange={setOpen}>
              ...
              <DropdownMenuContent align="end" className="w-screen max-w-none left-0 right-0 px-4">
                {/* Navigation Items */}
                {navigationItems.map((item) => (
                ...
                {!isAuthenticated ? (
                  <>
                    ...
                    <DropdownMenuItem asChild>
                      <Link to={ROUTES.NEW_REGISTRATION} onClick={() => setOpen(false)}>
