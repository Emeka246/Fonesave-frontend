            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-zinc-300 text-sm text-balance">
                  Trusted by phone users and agents across the World for secure
                  device verification.
                </p>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2">
              ...
              <p className="text-zinc-600 dark:text-zinc-300 mb-4 text-balance">
                Our platform leverages cutting-edge tools and a vast device
                database to deliver fast, reliable results.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-zinc-600 dark:text-zinc-300">
                ...
                <li>
                  <a
                    href="https://x.com/Fonsaveofficial?t=83B1NlbpC8RQ9cNHI3wOsA&s=09"
                    target="_blank"
            ...
            <div>
              ...
              <ul className="space-y-2 text-zinc-600 dark:text-zinc-300">
                <li>
                  <Link to="/about" className="hover:" onClick={scrollToTop}>
                    About Us
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/contact" className="hover:" onClick={scrollToTop}>
                    Contact
                  </Link>
                </li>
              </ul>
