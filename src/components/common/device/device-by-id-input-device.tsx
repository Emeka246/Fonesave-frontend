...
export default function DeviceByIdInput() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (
        error?.data?.code === "DEVICE_NOT_FOUND" ||
        error?.data?.message?.includes("Device not found")
      ) {
        setShowUnregisteredModal(true);
      } else {
        setError(
          error?.data?.message || "Device not found or an error occurred"
        );
      }
    } finally {
      setIsLoading(false);
    ...
    <>
      <Card className="rounded-2xl shadow-lg p-4 md:p-8 gap-4 md:gap-6">
        <CardHeader className="px-4 md:px-6">
          ...
          <CardDescription>
            Enter your 15-Digits IMEI for instant verification
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col gap-4 px-4 md:px-6">
          <Button
            ...
            disabled={isLoading}
            className="w-full rounded-full py-3 h-12 hover:opacity-80 flex items-center justify-center space-x-2"
          >
            {isLoading ? (
              <>
                <svg
              ...
              <div className="text-center p-6 border rounded-lg">
                ...
                <Badge
                  className={`${getStatusColor(
                    searchResult.deviceStatus
                  )} px-3 py-1 md:px-4 md:py-2 text-base font-semibold rounded-full`}
                >
                ...
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="py-2 px-2">
                      {searchResult.deviceBrand || "—"}
                    </td>
                  </tr>
                  <tr className="border-b">
                    <td className="font-medium py-2 px-2 border-r">Model</td>
                    <td className="py-2 px-2">
                      {searchResult.deviceModel || "—"}
                    </td>
                  </tr>
                  {searchResult.deviceName && (
                    <tr className="border-b">
                      <td className="font-medium py-2 px-2 border-r">
                        Device Owner Name
                      </td>
                      <td className="py-2 px-2">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h4 className="text-red-800 dark:text-red-300 font-semibold">
                        Warning: Stolen Device
                      </h4>
                      <p className="text-red-700 dark:text-red-400 text-xs md:text-sm mt-1">
                        This device has been reported as stolen. Do not purchase
                        or use this device. Contact authorities if you have
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-yellow-700 dark:text-yellow-400 text-xs md:text-sm mt-1">
                        This device has been reported as lost. Please verify
                        ownership before purchasing or using this device.
                      </p>
                      {searchResult.ownerMessage && (
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-400 text-xs md:text-sm mt-1">
                        This device has been blocked by the carrier or
                        manufacturer. It may not work properly on networks.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {searchResult.deviceStatus === "CLEAN" && (
                <div className="bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="text-emerald-800 dark:text-emerald-300 font-semibold">
                        Device Verified
                      </h4>
                      <p className="text-emerald-700 dark:text-emerald-400 text-xs md:text-sm mt-1">
                        This device appears to be legitimate and safe to use. No
                        theft reports found in our database.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-400 text-xs md:text-sm mt-1">
                        We couldn't determine the status of this device. Please
                        verify the IMEI and try again.
                      </p>
                    </div>
                  </div>
                </div>
