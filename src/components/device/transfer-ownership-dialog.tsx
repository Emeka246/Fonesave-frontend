...
export function TransferOwnershipDialog({
  ...
  const handleConfirmTransfer = async () => {
    ...
    try {
      ...
      if (response?.success) {
        toast.success(
          "Device transferred and removed from your account successfully!"
        );
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              Transfer <strong>{deviceName}</strong> to another person or delete
              it from your account. This action will remove the device from your
              account.
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm">
              This action will permanently remove your ownership of this device
              on FoneOwner.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <ul className="text-sm text-red-800 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Once transferred, you will no longer be able to manage or
                    update this device.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600 font-bold">•</span>
                  <span>
                    The new owner will have full control to register and manage
                    it.
                  </span>
                </li>
                <li className="flex items-start gap-2">
